...
# APP CONFIG + THEME
# ================================================================
st.set_page_config(page_title="TN Forest — KML Grid Generator v4.3", layout="wide")
...
🌿 Tamil Nadu Forest Department — KML Grid Generator v4.3
</div>
""", unsafe_allow_html=True)
...
def generate_labeled_kml(cells_ll, merged_ll, user_inputs, overlay_gdf=None):
    ...
    etree.SubElement(doc, "{%s}description" % ns).text = (
        "Generated grid and overlay polygons for forest invasive monitoring.\n"
        "Developed by Rasipuram Range, TNFD."
    )
