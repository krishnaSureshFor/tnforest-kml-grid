...
import os
# 🔧 Force remove legacy fpdf (old version conflicts with fpdf2)
...
def build_pdf_report_standard(cells_ll, merged_ll, user_inputs, cell_size, overlay_present):
    ...
    # ✅ Add Unicode-compatible font (DejaVu Sans). Ensure DejaVuSans.ttf is in the repo root.
    ...
    # ✅ Correct indentation: this is outside the loop
    pdf.ln(3)
